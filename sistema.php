<?php
    ...
    // Lógica para recuperar e exibir os pedidos
...
$sqlrelatorio = "UPDATE relatorio SET pedidosN = $quantidadeLinhas";
...
while ($user_data = mysqli_fetch_assoc($result)) {
    ...
    echo "<td>
    <a class='btn btn-sm btn-purple' href='edit.php?id=$user_data[id]' title='Editar'>
        ...
        <a class='btn btn-sm btn-danger' href='delete.php?id=$user_data[id]' title='Deletar'>
            <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash-fill' viewBox='0 0 16 16'>
                <path d='M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a.5.5 0 0 0 1 0v-7a.5.5 0 0 0 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM11 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5z'/>
            </svg>
        </a>
    </td>";
